...
func tableKolidePersonRegisteredDevice(_ context.Context) *plugin.Table {
	return &plugin.Table{
		...
		Columns: []*plugin.Column{
			...
			// Other columns
			{Name: "id", Description: "Canonical identifier for the device.", Type: proto.ColumnType_STRING, Transform: transform.FromField("DeviceInformation.Identifier")},
...
func listDeviceByPerson(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
	...
	return listAnythingById(ctx, d, h, "kolide_person_registered_device.listDeviceByPerson", "person_id", visitor, "Devices")
}
