...
func tableKolidePersonOpenIssue(_ context.Context) *plugin.Table {
	return &plugin.Table{
		Name:        "kolide_person_open_issue",
...
func listIssuesByPerson(ctx context.Context, d *plugin.QueryData, h *plugin.HydrateData) (interface{}, error) {
